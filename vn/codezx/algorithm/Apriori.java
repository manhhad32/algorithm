...
public class Apriori {
  ...
  private static Map<Set<String>, Integer> createL1(List<List<String>> transactions,
      int minSupportCount) {
  ...
  private static Map<Set<String>, Integer> generateAndFilterCandidates(
      List<Set<String>> prevFrequentItemsets, List<List<String>> transactions,
      int minSupportCount) {
  ...
  public static Map<Set<String>, Integer> apriori(List<List<String>> transactions,
      int minSupportCount) {
    // Tính toán L1
    ...
    while (!currentFrequentItemsets.isEmpty()) {
      ...
      Map<Set<String>, Integer> fItemSet = generateAndFilterCandidates(currentFrequentItemsets,
          transactions, minSupportCount);
